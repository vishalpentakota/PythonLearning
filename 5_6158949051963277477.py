...
def copy1():
    print("this program is created by UTSAV MEHROTRA")


display = Label(root, text="ON SCREEN KEYBOARD", fg="black", bg="yellow")
...
up = Button(frame3, text="up", bg="red", fg="white")
up.pack(side=LEFT)
...
left = Button(frame4, text="Left", bg="red", fg="white")
left.pack(side=LEFT)


down = Button(frame4, text="Down", bg="red", fg="white")
down.pack(side=LEFT)


right = Button(frame4, text="Right", bg="red", fg="white")
right.pack(side=LEFT)

copy = Button(root, text="copyright", fg="black", command=copy1)
copy.pack(side=RIGHT)
copy.config(font=("courier", 1))


def copy():
    print("this project is created by Utsav Mehrotra")
